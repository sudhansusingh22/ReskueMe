...
namespace ResKueMe
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
         /*   String errorMessage= "Following items needs immediate attention:\n";
            ...
            if (geolocator.LocationStatus == PositionStatus.Disabled)
            {
                ...
                if (isNetwork == false)
                {
                    errorMessage += "Please turn on internet connection:either connect a wifi of turn on mobile connectivity.";
                    System.Diagnostics.Debug.WriteLine(errorMessage);
                }
                System.Diagnostics.Debug.WriteLine(errorMessage);
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("m here ");
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            //will show MessageBox box incase of the an UnhandledException exception occurs
